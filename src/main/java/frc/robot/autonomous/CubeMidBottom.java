...
public class CubeMidBottom extends SequentialCommandGroup {
  /** Creates a new CubeMidBottom. */
  public CubeMidBottom(DriveSubsystem m_robotDrive, ShoulderSubsystem m_shoulder, GripperPitchSubsystem m_gripper, ArmExtensionSubsystem m_arm, GripperSubsystem m_claw) {
    ...
    addCommands(poseReset,
                ...
                new MediumScore(m_shoulder, m_gripper, m_arm),
                new WaitCommand(3),
